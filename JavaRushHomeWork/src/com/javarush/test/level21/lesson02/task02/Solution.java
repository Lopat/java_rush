...
//        System.out.println(allModifiers + " " + Integer.toBinaryString(allModifiers));
//        System.out.println(specificModifier + " " + Integer.toBinaryString(specificModifier));
//        System.out.println(a + " " + Integer.toBinaryString(a));
        if (a == specificModifier) {
            return true;
        } else {
            return false;
        }
