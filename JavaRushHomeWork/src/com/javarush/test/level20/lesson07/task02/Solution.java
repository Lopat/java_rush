...
//
//        OutputToConsole toConsole = new OutputToConsole();
//        toConsole.writeExternal(new ObjectOutputStream(new FileOutputStream(file)));
//
//        OutputToConsole newToConsole = new OutputToConsole();
//        newToConsole.readExternal(new ObjectInputStream(new FileInputStream(file)));
//
//    }
